...
- `01_response_map_h_mu_by_mass.png` / `01_response_map_h_mu_by_mass.svg`
  ...
  - Importa: Resume la frontera operacional aprendida por lotes dirigidos usando todos los casos oficiales hasta AL2.
...
- `03_batch_story_margin_strip.png` / `03_batch_story_margin_strip.svg`
  ...
  - Importa: Cuenta visualmente como el experimento dirigido paso de extremos a puntos de frontera hasta AL2.
...
- `08_mass_effect_displacement_summary.png` / `08_mass_effect_displacement_summary.svg` (apoyo)
  ...
  - Importa: Resume el aprendizaje central de batch4/AL1/AL2: m* baja aumenta criticidad.
